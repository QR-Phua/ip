...
public class ParserTest {
    ...
    @Test
    public void parseTaskArguments_eventEmptyDescription_throwsIncompleteDetailsException() {
        String[] tokens = new String[]{"event", "/from", "2026-01-01", "0900", "/to", "2026-01-01", "1700"};
        assertThrows(IncompleteDetailsException.class, () -> Parser.parseTaskArguments(
                tokens, AlphaOne.TaskType.EVENT));
    }
}
